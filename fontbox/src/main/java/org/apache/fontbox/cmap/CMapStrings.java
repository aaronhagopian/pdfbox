...
public class CMapStrings
{
    ...
    private static final List<Integer> indexValues = new ArrayList<Integer>(256 * 256);
    private static final List<byte[]> oneByteValues = new ArrayList<byte[]>(256);
    private static final List<byte[]> twoByteValues = new ArrayList<byte[]>(256 * 256);
    ...
    public static Integer getIndexValue(byte[] bytes)
    {
        ...
        return indexValues.get(CMap.toInt(bytes, bytes.length));
    }
    ...
    public static byte[] getByteValue(byte[] bytes)
    {
        ...
        return bytes.length == 1 ? oneByteValues.get(CMap.toInt(bytes, 1))
                : twoByteValues.get(CMap.toInt(bytes, 2));
    }
}
